...
add-highlighter shared/liquid/code/ regex \b(or|and|contains|for|in|if|elsif|else|endif|case|when|unless|endunless|for|break|continue|cycle|tablerow|endfor|echo|include|form|endform|liquid|paginate|raw|render|section|style|endstyle|javascript|endjavascript|stylesheet|endstylesheet|schema|endschema|assign|capture|increment|decrement|comment|endcomment)\b 0:keyword
